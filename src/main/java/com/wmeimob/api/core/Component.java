...
import com.wmeimob.api.common.HttpClient;
import com.wmeimob.api.exception.WmeimobException;
import com.wmeimob.api.model.base.ApiResult;
...
public abstract class Component {
   // protected static final JavaType MAP_STRING_OBJ_TYPE = Jsons.DEFAULT.createCollectionType(Map.class, String.class, Object.class);
    ...
    private String error(String content){
        log.debug("校验响应参数,content={}",content);
        if (content == null ){
            return "";
        }
